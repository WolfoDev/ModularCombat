NPCs = {
...

	{
		...
		npc = "npc_fastzombie",
		health = function() return math.random(25,28) end,
		size = 1.5,
		weapon = "",
		type = "metal",
		exp = 750,
...

	{
		...
		npc = "npc_vortigaunt",
		health = function() return math.random(15,25) end,
		size = 1,
		weapon = "",
		type = "medic",
		exp = 180,
...

	{
		...
		npc = "npc_rollermine",
		health = function() return math.random(8,12) end,
		size = 1,
		weapon = "",
		type = "medic",
		exp = 150,
...

	{
		...
		npc = "npc_rollermine",
		health = function() return math.random(20, 35) end,
		size = 1,
		weapon = "",
		type = "metal",
		exp = 250,
